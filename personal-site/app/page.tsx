            ...
            <p>
              ...
              <section className="mt-6">
                    ...
                    <ul className="list-disc list-inside space-y-1">
                      <li>Playing <a href="https://youtu.be/93qncUjGpt0?si=WDZzJVTTz3-Z-M-a&t=181" target="_blank" rel="noopener noreferrer" className="hover:underline" style={{color: '#D41795'}}>violin and composing music</a></li>
                      <li>Ceramics</li>
